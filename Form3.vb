Public Class Form3
    ...
    Private Sub DisplayFlights()
        ...
        For Each flight In GlobalDataa.flights
    ...
    Private Sub ajt_v_Click(sender As Object, e As EventArgs) Handles ajt_v.Click
        ...
        GlobalDataa.flights.Add(newFlight)
    ...
    Private Sub modif_v_Click(sender As Object, e As EventArgs) Handles mdf_v.Click
        ...
        If lst_vol.SelectedRows.Count > 0 Then
            ...
            GlobalDataa.flights(selectedIndex).FlightNumber = num_vol.Text
            GlobalDataa.flights(selectedIndex).Destination = dest.Text
            GlobalDataa.flights(selectedIndex).FlightDate = Date_vol.Value
            GlobalDataa.flights(selectedIndex).AvailableSeats = CInt(num_place.Value)
            GlobalDataa.flights(selectedIndex).Price = CDec(prix.Text)
    ...
    Private Sub suppr_v_Click(sender As Object, e As EventArgs) Handles sup_v.Click
        ...
        If lst_vol.SelectedRows.Count > 0 Then
            ...
            GlobalDataa.flights.RemoveAt(selectedIndex)
